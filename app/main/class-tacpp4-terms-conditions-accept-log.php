            ...
            if ( ! empty( $accepted_items ) ) {
				...
				<div class="acceptance-terms-wrapper">
					<table id="user-accepted-terms">
						<thead>
						<tr>
							<th class="center"><?php _e( 'S/N', 'terms-and-conditions-per-product' ); ?></th>
							<th><?php _e( 'Terms Type', 'terms-and-conditions-per-product' ); ?></th>
							<th><?php _e( 'Terms Text & Link', 'terms-and-conditions-per-product' ); ?></th>
                        ...
                        foreach ( $accepted_items as $key => $item ) {
							...
							<tr>
								...
								<td>
									...
									<a href="<?php echo $type_link['url']; ?>" title="<?php
                                    printf(
